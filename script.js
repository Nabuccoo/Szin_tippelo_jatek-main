...
//Közreműködők: Bartha Szabolcs, Pataki György :)
//A projekt kiinduló alapja: https://codepen.io/itsmhuang/pen/oxaReK
// Ezt próbáltam fejleszteni. Maxumim tipp szám 3 és jó tippekért számolja a pontokat.
//Van még mit javítani rajta. Nem minden működik/ úgy működik, ahogy szerettem volna.
        ...
        negyzetek[i].addEventListener("click", function () {
            if (this.title == "0" && !kirakva) {
                ...
                if (tipp === 0) {
                    ...
                    // negyzetek.style.display = "none";  ez rossz
                    negyzetekTiltas();
                    pont = 0;
                }
            }
...
//Elcsesződött a nehézség váltó. Nem akarja egyből átváltani a négyzetek számát, rá kell keverni egyet.
...
//Egy nagy téglalappá alakulva jelezné a helyes tippet.
function effekt() {
